package com.example.aop_part6_chapter07.presentation.home
...
import com.example.aop_part6_chapter07.databinding.ItemFeaturedMovieBinding
import com.example.aop_part6_chapter07.databinding.ItemMovieBinding
...
import com.example.aop_part6_chapter07.extension.dip
    ...
    inner class FeaturedMovieItemViewHolder(private val binding: ItemFeaturedMovieBinding) :
        ...
        fun bind(item: FeaturedMovie) {
            ...
            binding.averageScoreTextView.text =
                item.movie.averageScore?.toDecimalFormatString("0.0")
